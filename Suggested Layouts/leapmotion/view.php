          ...
          <div name="sign-in-form">
            <form onsubmit="return Forms.submitOnlyOnce();" method="post" novalidate="novalidate" action="">
              <div id="login-partial">
                <div id="User-field">
                  <label id="User-label" for="login_User">Patient<br />
                  </label>
                 <select>
  <option value="Old Records">New</option>
  <option value="New Records">new</option>
                ...
                <div id="login-footer">
                  ...
                  <input name="login_submit_dummy" value="Start" type="submit" id="login_submit" tabindex="4" />
                </div>
              </div>
            </form>
          </div>
